...
const Footer = () => {
  const footerLinks = [
    { label: "About REACH Footwear Nester", path: "/about" },
    { label: "Benefits of REACH Footwear Nester", path: "/benefits" },
    // { label: "Learning Guides", path: "/learningguide" },
    // { label: "Presentations", path: "/presentations" },
    { label: "REACH Footwear Nester Images", path: "/rmmimages" },
        ...
        <div className="grid md:grid-cols-3 gap-8">
          <div>
            <Link to="/" className="text-2xl font-bold mb-4 block w-fit">
              <span className="text-primary">REACH</span> Footwear Nester
            </Link>
            ...
            <div className="mt-6 space-y-4">
              ...
              <div className="flex items-center gap-3">
                <img src={emailIcon} alt="Email contact for REACH Tech" className="w-8 icon-a31951" />
              ...
              >
                <img src={whatsappIcon} alt="Whatsapp contact for REACH Tech" className="w-8 icon-a31951" />
                <span className="text-gray-300 text-lg">
                  +91 84592 78496
                </span>
              </a>
              ...
              >
                <img src={contactIcon} alt="Contact form link for REACH Tech" className="w-7 icon-a31951" />
                <span className="text-gray-300 text-lg">
                  Write to Us
                </span>
              </a>
