        ...
        <div className="container mx-auto px-4 py-2">
          <div className="flex flex-wrap items-center justify-end gap-5 text-sm sm:text-base">
            ...
            <div className="flex items-center gap-2">
              <img src={emailIcon} alt="Email contact for REACH Tech" className="w-5 sm:w-6 icon-a31951" />
            ...
            >
              <img src={whatsappIcon} alt="Whatsapp contact for REACH Tech" className="w-5 sm:w-6 icon-a31951" />
            ...
            <a
              ...
              className="flex items-center gap-2"
            >
              <img src={contactIcon} alt="Contact form link for REACH Tech" className="w-5 sm:w-6 icon-a31951" />
        ...
        <div className="container mx-auto px-4 py-4">
          ...
          <div className="flex flex-col lg:flex-row items-center justify-between gap-6">
            ...
            <Link to="/" className="text-3xl sm:text-4xl font-bold">
              ...
              <span className="text-black"> Footwear Nester</span>
            </Link>
