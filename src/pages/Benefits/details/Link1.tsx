    ...
    <>
      ...
      <div className="p-6 sm:p-10 max-w-5xl mx-auto">
        ...
        <div className="bg-gray-100 p-8 sm:p-10 rounded-2xl text-lg sm:text-xl leading-relaxed space-y-8 shadow-sm">
          ...
          <p>
            Save time by automating the nesting process. Let the algorithms work overnight, even when no one is around, and have the nested layouts of footwear ready in the morning.
          </p>
